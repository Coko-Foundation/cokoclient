...
export const ControlPage = meta.story({
  render: (): ReactElement => {
    const [currentPage, setCurrentPage] = useState(1)
      ...
      <>
        ...
        <aside>
          <p>
            ...
            correctly. You can pass a ref to the component which will be
            attached to the pagination&apos;s <code>&lt;nav&gt;</code> wraper,
            and you can use it to make the accessibility adjustements.
          </p>
        </aside>
      </>
    )
